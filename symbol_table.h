...
//   linelistRec用来记录一个变量在声明以后他具体会出现在哪些行，并将这些行用链表连接起来
// */
...
// {   
//   struct symbolTable * st; /* pointer to the containing symbol table.*///记录链表最开头的结点
//   TreeNode * nd;  /*pointer to the declaration node or parameter node in the syntax tree.*/  //made by parser
...
// /* st_insert_dcl(): symbol table insert declaration
//    [computation]:
...
// /* st_insert_ref() symbol table insert reference
//    [computation]:
